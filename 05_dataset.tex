...
\begin{figure}[ht]
  ...
  \caption{
    ...
    collision point on left) ~\cite{Kim2016}
  }
...
\begin{figure}[ht]
  ...
  \caption{
    Shown: A beam-view of the MuTR tracking planes
    with additional variabled engineered from track
    reconstruction~\cite{Kim2016}.
  }
...
not generally partitioned in this way. A complete summary of the kinematic
variables is presented in Figures~\ref{fig:kinvar_side_view}
and~\ref{fig:kinvar_beam_view}.
\clearpage

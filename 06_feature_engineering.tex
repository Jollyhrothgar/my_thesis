...
k-factor) such that di-muon events are properly accounted for.
...
Virtual photons, $d\gamma$ (sometimes also written as DY) refer
to photons that are produced from processes resulting of a inelastic scattering
...
\begin{table}[ht]
  ...
  \caption{
    ...
    k-factor. Processes which contribute very little to the muon background
    include W had, W tau, and $d\gamma$; they are scaled to zero.
  }

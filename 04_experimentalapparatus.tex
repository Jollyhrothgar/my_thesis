...
designated intersection points, around which experiments are built. Bunches from
the blue and yellow beam collide at various interaction points around RHIC. The
blue beam's bunch crossing frequency is chosen as the master timing source as a
means of keeping track of exactly what polarization configuration is colliding
at the various interaction points around RHIC. This is required for any
measurement which requires a knowledge of the initial polarization state of
colliding hadrons (such as any spin physics measurement). This will be discussed more in the section of beam-polarization
(\ref{sec:beam_polarization}).

\textcolor{red}{\textbf{RESUME HERE}}
...
in various databases and online logbooks. This is done for a variety of reasons.
ch fill is a unique population of

...
been repurposed to create a high quality collider physics experiement. Many
...
the beam can be lowered to create a highly colimated beam for physics use.
...
Once sufficiently polarized and filled into the AGS

\clearpage
\section{Maintaining Beam Polarization}

\subsection{Siberean Snakes and Spin Rotators}

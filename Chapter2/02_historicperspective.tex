...
\begin{figure}[ht]
	...
	\caption{
		...
		century quantum mechanics that electron orbitals were discovered. Soon,
...
Deep inelastic scattering experiments, Figure~\ref{disschematic} were a natural
...
produce predictions consistent with these observations.

\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{../Chapter2/fig/deep_inelastic_basic.png}
	\caption{
		A schematic of deep inelastic scattering, where the incoming

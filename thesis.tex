...
\documentclass[oneside,final, letterpaper]{classes/ucr}
\input{packages}
...
\input{sections/02_historicperspective.tex   }
\input{sections/03_modelingprotonspin.tex    }
\input{sections/04_experimentalapparatus.tex }
\input{sections/05_dataset.tex               }
\input{sections/06_spinanalysis.tex          }
\input{sections/07_vernieranalysis.tex       }
\input{sections/08_discussionconclusion.tex  }

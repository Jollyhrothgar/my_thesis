...
%% Flag Thesis For Draft %% 

\usepackage{fancyhdr}                % Remove for final
\renewcommand{\headrulewidth}{0.4pt} % Remove for final
\pagestyle{fancy}                    % Remove for final
\lhead{\textcolor{red}{DRAFT}}       % Remove for final
\rhead{\textcolor{red}{DRAFT}}       % Remove for final
\chead{\textcolor{red}{DRAFT}}       % Remove for final

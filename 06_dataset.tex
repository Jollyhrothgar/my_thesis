...
efficiencies are reproduced from~\cite{Seidl2014}.  Additional related plots and
...
(((MUIDLL1\_N2D$\|$S2D)$\|$(N1D\&S1D))\&BBCLL1(noVtx)) ), with remaining Figures
...
The same is true even stronger in Figure~\ref{fig:totaltrigeffi_all_wpt1} where
